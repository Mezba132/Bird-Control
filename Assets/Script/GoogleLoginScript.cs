...
namespace Firebase.Sample.Database {
	...
	public class GoogleLoginScript : MonoBehaviour {
		...
		TransactionResult AddScoreTransaction(MutableData mutableData) {
			...
			newScoreMap["fullname"] = fullName;
			newScoreMap["phone"] = phone;
		...
		public void AddScore() {
			...
			DatabaseReference reference = FirebaseDatabase.DefaultInstance.GetReference("UserProfile");
		...
		void GUIDisplayControls() {
			if (UIEnabled) {
				...
				GUILayout.BeginHorizontal();
				GUILayout.Label("FullName:", GUILayout.Width(Screen.width * 0.20f));
				fullName = GUILayout.TextField(fullName);
				GUILayout.EndHorizontal();
				...
				GUILayout.BeginHorizontal();
				GUILayout.Label("Phone:", GUILayout.Width(Screen.width * 0.20f));
				int.TryParse(GUILayout.TextField(phone.ToString()), out phone);
				GUILayout.EndHorizontal();

				GUILayout.Space(20);

				GUILayout.BeginHorizontal();
				GUILayout.Label("Client ID:", GUILayout.Width(Screen.width * 0.20f));
				...
				if (GUILayout.Button("Back")) {
					...
					showProfile.gameObject.SetActive (true);
